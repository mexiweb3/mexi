    ...
    <main className="min-h-screen bg-brand-50 text-brand-900">
      ...
      <section className="mx-auto max-w-md px-6 pb-20 pt-4">
        ...
        <p className="mt-3 text-brand-800">
          Accede a la cuenta del padre o madre para ver el progreso de tu hijo.
        </p>
        ...
        <p className="mt-8 text-center text-sm text-brand-700">
          ...
          <Link href="/registro" className="font-semibold underline decoration-brand-300 underline-offset-4 hover:text-brand-600">
            Crear cuenta gratis
          </Link>
        </p>
      </section>

...
import { m2l1 } from "@/lib/lessons/content/m2l1";
import { m2l2 } from "@/lib/lessons/content/m2l2";
import { m2l3 } from "@/lib/lessons/content/m2l3";
import { m2l4 } from "@/lib/lessons/content/m2l4";
import { m2l5 } from "@/lib/lessons/content/m2l5";
...
export const LESSON_CATALOG: readonly LessonCatalogEntry[] = [
  ...
  { id: "m2l1", module: 2, order: 1, title: "El pulso del corazon", premium: true, ready: true },
  { id: "m2l2", module: 2, order: 2, title: "Notas largas, notas cortas", premium: true, ready: true },
  { id: "m2l3", module: 2, order: 3, title: "Manos al teclado", premium: true, ready: true },
  { id: "m2l4", module: 2, order: 4, title: "Mi segunda cancion", premium: true, ready: true },
  { id: "m2l5", module: 2, order: 5, title: "Mi primer concierto", premium: true, ready: true },
];

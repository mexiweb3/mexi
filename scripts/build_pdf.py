...
/* Unavailable: thin red banner in top-right corner — art stays untouched */
.card-na .card-img {{
  border-color: #000;
}}
.card-na .tag-na {{
  ...
  font-size: 3.2pt; letter-spacing: .15em; text-transform: uppercase;
  background: #c0392b; color: #fff; padding: 0.3mm 1mm;
...
<section class="manual">
  ...
  <ol class="steps">
    ...
    <li>
      ...
      <div class="body">
        <h3>Escríbeme a mí para coordinar el envío.</h3>
        <p>
          Mándame tu dirección pública por WhatsApp a
          <strong>Mauricio Cruz</strong> ·
          <a href="https://wa.me/528180283874" target="_blank" rel="noopener"><strong>+52 81 8028 3874</strong></a>.
          En cuanto la reciba, te coordina el envío de la transferencia y tu
          pieza aparecerá en la pestaña <em>Coleccionables</em> de Phantom en
  ...
  <div class="security">
    ...
    <ul>
      <li><strong>Nadie</strong>, ni Mauricio Cruz, ni Phantom, ni soporte técnico, te pedirá tu frase de recuperación. Si te la piden, es un fraude.</li>
  ...
  <p class="signoff">
    <em>Una vez que tengas tu cartera, escribe a Mauricio Cruz — la pieza
    viaja en segundos y se queda contigo, en cadena, para siempre.</em>
  </p>
</section>
